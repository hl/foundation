defmodule FoundationWeb.CollectionLiveTest do
  use FoundationWeb.ConnCase

  import Phoenix.LiveViewTest
  import Foundation.CollectionsFixtures

  @create_attrs %{description: "some description", fields: %{}, name: "some name"}
  @update_attrs %{description: "some updated description", fields: %{}, name: "some updated name"}
  ...
  describe "Index" do
    ...
    test "lists all collections", %{conn: conn, collection: collection} do
      ...
      assert html =~ collection.description
    end
